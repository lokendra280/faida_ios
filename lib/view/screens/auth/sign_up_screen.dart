...
import 'package:faidanepal/data/model/body/signup_body.dart';
              ...
              child: Container(
                ...
                child: GetBuilder<AuthController>(builder: (authController) {
                  return Column(children: [
                    ...
                    // Center(child: Text(AppConstants.APP_NAME, style: SyneMedium.copyWith(fontSize: Dimensions.fontSizeLarge))),
                    SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_LARGE),

                    // Text('sign_up'.tr.toUpperCase(),
                    //     style: SyneBlack.copyWith(fontSize: 30)),
                    // SizedBox(height: 50),

                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                      Text("Your First Name",style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.w500,fontSize: 15),),
                      SBC.lH,
                      CustomTextField(
                      ...
                      Text("Your Last Name",style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.w500,fontSize: 15),),
                      SBC.lH,
                      CustomTextField(
                        ...
                        Text("Email",style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.w500,fontSize: 15),),
                      SBC.lH,
                      CustomTextField(
                        hintText: 'email'.tr,
                      ...
                      Row(children: [
                        CodePickerWidget(
                          ...
                          textStyle: SyneRegular.copyWith(
                      ...
                      SBC.lH,
                        Text("Password",style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.w500,fontSize: 15),),
                      SBC.lH,
                      CustomTextField(
                        ...
                        SBC.lH,
                        Text("Confirm Password",style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.w500,fontSize: 15),),
                      SBC.lH,
                      CustomTextField(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              ...
                              style: Theme.of(context).textTheme.bodyText2.copyWith(color: Color.fromRGBO(136, 136, 136, 1)),
                            ),
                            PrimaryTextButton(
                              title: 'Login',
                              color: Colors.black,
