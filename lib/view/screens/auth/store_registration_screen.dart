...
import 'package:faidanepal/data/model/body/store_body.dart';
...
import 'package:faidanepal/view/screens/auth/widget/module_view.dart';
import 'package:faidanepal/view/screens/auth/widget/select_location_view.dart';
                              ...
                              ? CustomButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (_name.isEmpty) {
                                      ...
                                      print(
                                          '%%%%%%%%%%%${Get.find<SplashController>().moduleList[Get.find<SplashController>().selectedModuleIndex].id}');
                                      authController.registerStore(StoreBody(
                                        ...
                                        zoneId: authController
                                            ...
                                            .id
                                            .toString(),
                                        moduleId: Get.find<SplashController>()
                                            .moduleList[
