                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    return Column(children: [
                      ...
                      Column(
                        ...
                        children: [
                        Text('WELCOME',
                          style: SyneBlack.copyWith(fontSize: 20)),
                              Text('please login or sign up to continue our app',
                          style: Theme.of(context).textTheme.caption.copyWith(fontWeight: FontWeight.w500,fontSize: 14),),
                        ],
                      ),
                      SBC.lH,
                      // SizedBox(height: 50),
