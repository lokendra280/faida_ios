...
import 'package:faidanepal/view/screens/chat/widget/message_bubble.dart';
              ...
              : AppBar(
                centerTitle: true,
                  ...
                  title: Text(chatController.messageModel != null
                      ...
                      : 'receiver_name'.tr,style: Theme.of(context).textTheme.bodyText2.copyWith(color: Color.fromRGBO(0, 0, 0, 1),fontWeight: FontWeight.w600,fontSize: 16),
                       ),
