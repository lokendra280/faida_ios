...
import 'package:faidanepal/view/base/custom_ink_well.dart';
...
import 'package:faidanepal/view/screens/search/widget/search_field.dart';
...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        appBar: CustomAppBar(title: 'Chat List'.tr),
                                                            ...
                                                            child: Column(
                                                              ...
                                                              _user != null
                                                                  ? Text(
                                                                      ...
                                                                      style:
                                                                          SyneMedium.copyWith(fontWeight: FontWeight.w600,fontSize: 16),
                                                                    )
                                                                  : Text(
                                                                      '${_type.tr} ${'deleted'.tr}',
                                                                      style:
                                                                          SyneMedium.copyWith(fontWeight: FontWeight.w500,fontSize: 13)),
                                                              SizedBox(
                                                                  height: Dimensions
