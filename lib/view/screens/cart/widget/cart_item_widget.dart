...
import 'package:faidanepal/view/base/item_bottom_sheet.dart';
import 'package:faidanepal/view/base/quantity_button.dart';
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Row(children: [
                              ...
                              Text(addOns[index].name, style: SyneRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                              SizedBox(width: 2),
                              Text(
                                PriceConverter.convertPrice(addOns[index].price),
                                style: SyneMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                              ),
                              SizedBox(width: 2),
                              Text(
                                '(${cart.addOnIds[index].quantity})',
                                style: SyneRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                              ),
                            ]),
                          );
                        },
