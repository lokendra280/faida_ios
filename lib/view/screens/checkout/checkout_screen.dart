...
import 'package:faidanepal/data/model/body/place_order_body.dart';
...
import 'package:faidanepal/view/base/image_picker_widget.dart';
import 'package:faidanepal/view/base/menu_drawer.dart';
import 'package:faidanepal/view/base/my_text_field.dart';
...
import 'package:faidanepal/view/screens/cart/widget/delivery_option_button.dart';
import 'package:faidanepal/view/screens/checkout/widget/payment_button.dart';
import 'package:faidanepal/view/screens/checkout/widget/slot_widget.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:faidanepal/view/screens/checkout/widget/tips_widget.dart';
                  ...
                  KhaltiScope.of(context).pay(
                    ...
                    onSuccess: (PaymentSuccessModel model) {
                      ...
                      orderController.placeOrder(
                          PlaceOrderBody(
                              cart: carts,
                              couponDiscountAmount: Get.find<CouponController>()
                                  .discount,
                              distance: orderController.distance,
                              scheduleAt: !storeController.store.scheduleOrder
                                  ? null
                              ...
                              dmTips: _tipController.text.trim(),
                              esewaresult: '',
                              khaltiresult: model.toString()),
                          _callback);
                    },
                    onFailure: (PaymentFailureModel failure) {
                      showCustomSnackBar("Failed to complete the transaction");
                    },
                    onCancel: () {
                      showCustomSnackBar("Payment cancelled by user");
