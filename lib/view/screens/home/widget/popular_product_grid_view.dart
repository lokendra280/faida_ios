...
import 'package:faidanepal/view/base/not_available_widget.dart';
...
class PopularStoreViewGridView extends StatelessWidget {
  final bool isPopular;
  final bool isFeatured;
  PopularStoreViewGridView(
      {@required this.isPopular, @required this.isFeatured});
