...
import 'package:faidanepal/view/base/custom_divider.dart';
...
import 'package:faidanepal/view/screens/order/widget/address_details.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!_takeAway && track.deliveryMan == null)
          ...
          : Column(children: [
              Text('trip_route'.tr, style: SyneMedium),
