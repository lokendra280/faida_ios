...
import 'package:faidanepal/view/base/discount_tag.dart';
                      ...
                      children: [
                        ...
                        (widget.item.description != null &&
                            ...
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('description'.tr, style: SyneMedium),
                                  SizedBox(
                                      height:
                        ...
                        // Quantity
                        Row(children: [
                          Text('quantity'.tr, style: SyneMedium),
                        ...
                        (Get.find<SplashController>()
                            ...
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('addons'.tr, style: SyneMedium),
                                  SizedBox(
                                      height:
                                          Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  GridView.builder(
                        ...
                        Row(children: [
                          Text('${'total_amount'.tr}:', style: SyneMedium),
